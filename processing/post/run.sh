...
# File paths
ATTN_FILE="/net/mimer/mnt/tank/projects2/kvs_students/2025/jbo_unbiased_seq_annot/master_thesis/data/subset_01000/esm_output/esm_headQuan90_colQuan/attention/raw/"
...
RES_FILE="/net/mimer/mnt/tank/projects2/kvs_students/2025/jbo_unbiased_seq_annot/master_thesis/data/subset_01000/esm_processed/esm_headQuan90_colQuan.pkl"

python process_esm_attention.py -at $ATTN_FILE -ac $ACC_FILE -an $ANNO_FILE -p $PART_FILE -r $RES_FILE -q