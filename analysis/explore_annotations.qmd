...
Let's look at the number of annotations types being exluded.
...
I take a look at the frequency of the different annotations across the complete set and the subsets. Let's join the sets with a column marking the dataset type.

```{r}
data_path <- here("data/complete/annotations")
res_path <- here("reports/figures")

acc_00100 <- read.table(file = here("data/subset_00100/additional/accessions.txt"))
acc_01000 <- read.table(file = here("data/subset_00100/additional/accessions.txt"))
```
