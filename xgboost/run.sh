...
RES_DIR="/net/mimer/mnt/tank/projects2/kvs_students/2025/jbo_unbiased_seq_annot/master_thesis/xgboost/results/xgboost_headQuan90_colQuan_01000_1iter/"

time python train_xgboost_models.py -f $INPUT_FILE -res $RES_DIR -n 1